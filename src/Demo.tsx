...
function App() {
  ...
  return (
    <>
      <GithubCorner href="https://github.com/DomVinyard/auth0-react-node-ts" />
      {isLoading ? (
          ...
          <div style={{ margin: '2rem' }}>
            {isAuthenticated && (
              <div style={{ marginBottom: '5rem' }}>
                <h1>💫 Whoa!</h1>
                <p>
                  What happened there? Well, we sent you to Google's auth server
                ...
                <p>
                  ...
                  . This is what your token looks like, it was literally
                  generated just now, just for you:
                  <p
                    style={{
                      backgroundColor: '#ddd',
                      padding: 10,
                ...
                Now, every time you request data from our api we will inspect
                your token. If you try to look at something we don't want you
                seeing then we will stop you.
              </div>
            )}
            ...
            {wasUnauthenticated && (
              <div>
                <div style={{ marginTop: '2rem', marginBottom: '1rem' }}>
                  Nope. That's a secure endpoint. It needs a token. Where can we
                  get a token from?
                </div>
